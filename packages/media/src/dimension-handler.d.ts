 ...
 * ```
 */
export declare const getScaledDimensions: (width: number, height: number, maxWidth: number, maxHeight: number) => Dimensions;
/**
 ...
 * ```
 */
export declare const getObjectFitSize: (objectFit: string, elementSize: Dimensions, containerSize: Dimensions) => Dimensions;
//# sourceMappingURL=dimension-handler.d.ts.map